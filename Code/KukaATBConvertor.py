...
class file_conversion():
    ...
    def write_file(self,path,fileNameToWrite): 
        ...
        for i in range (0 , len(self.read_lines)):
            ...
            if  ";job_no" in newline.strip().lower() :
                var,job_no = newline.split("=")
                jobNumber = str(job_no).strip()
    ...
    def gui_parameter(self):
        ...
        tk.Label(gui,text="Ver. 0.3",bg="white",height=2,width=9).place(x= 540,y=-10)
        ...
        tk.Label(gui,text="Default Job Number",bg="white",).place(x= 0,y=110)
